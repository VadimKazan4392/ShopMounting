...
abstract class BaseController
{
    ...
    {
        $this->parametres = $args['parameters'];
    ...
    protected function render($path = '', $parametres = [])
    {
        extract($parametres);
        ...
        if(!$admin) {
            ...
            if(ADMIN_CSS_JS['styles']) {
                foreach(ADMIN_CSS_JS['styles'] as $item) {
                    $this->styles[] = PATH . ADMIN_TAMPLATE . trim($item, '/');
                }
            }

            if(ADMIN_CSS_JS['scripts']) {
                foreach(ADMIN_CSS_JS['scripts'] as $item) {
                    $this->scripts[] = PATH . ADMIN_TAMPLATE . trim($item, '/');
                }
            }
        }
    }
